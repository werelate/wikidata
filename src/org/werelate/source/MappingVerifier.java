...
public class MappingVerifier{
   ...
   public void checkPlaces(String filename) throws IOException{
      ...
      while(myIter.hasNext()){
         ...
         String num = fhlcPlaceToNum.get(place).trim();
         if(place.equals("Dax, Landes, France"))
            System.out.println("here it is big stuff" + num + '-');
         ...
         if(place.equals("Dax, Landes, France"))
            System.out.println("here it is big stuff" + num + '-' + numToWikiPlace.get(num));
         if(wikiplace == null || "".equals(wikiplace)){
            if(place.equals("Dax, Landes, France"))
               System.out.println("here it is big stuff" + num + '-' + numToWikiPlace.get(num));

            resultWriter.write(place + '|'+ num + '\n');
         }
      }
      resultWriter.close();
   }
